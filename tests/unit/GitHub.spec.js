...
describe('Componente GitHub', () => {
    ...
    it('Comprueba que muestra información (imagen, nombre, botón de repositorios) con usuario correcto', async () => {
        ...
        expect(imgUser.attributes('src')).to.equal('https://avatars1.githubusercontent.com/u/6128107?v=4','La URL del avatar del usuario no coincide con la que debería ser.');
...
describe('Componente GitHubRepos', () => {
    it('Comprueba que se muestra la lista de repositorios con usuario correcto', async () => {
        ...
        expect(repoList.contains('.badge'), 'Debe aparecer un componente badge de Bootstrap para mostrar las estrellas del repositorio.').to.be.true;
        expect(repoList.get('.badge').text(), 'La badge debe mostrar el número de estrellas.').to.exist;
